...
; #ENVIRONMENT# =================================================================================================================
; AutoIt3Wrapper
#AutoIt3Wrapper_Res_ProductName=fax_diademe_225
#AutoIt3Wrapper_Res_Description=Permet d'installer l'imprimante virtuelle PDFCreator : fax_diademe_225
...
Global $g_sOldPdfCreatorPrinter = "FAX DIADEME 225"
...
Func _InstallPdfCreatorPrinter()
	...
	If RegWrite('HKCU\Software\PDFCreator\Profiles\' & $g_sPdfCreatorPrinter & '\Printing', 'StampFontname','REG_SZ','Arial Narrow') <> 1 Then $iRegError += 1
	...
	If RegWrite('HKCU\Software\PDFCreator\Profiles\' & $g_sPdfCreatorPrinter & '\Printing', 'StampUseOutlineFont','REG_SZ','0') <> 1 Then $iRegError += 1
	...
	If RegWrite('HKCU\Software\PDFCreator\Profiles\' & $g_sPdfCreatorPrinter & '\Printing', 'UseCreationDateNow','REG_SZ','1') <> 1 Then $iRegError += 1
	...
	If RegWrite('HKCU\Software\PDFCreator\Profiles\' & $g_sPdfCreatorPrinter & '\Program', 'AllowSpecialGSCharsInFilenames','REG_SZ','0') <> 1 Then $iRegError += 1
	...
	If RegWrite('HKCU\Software\PDFCreator\Profiles\' & $g_sPdfCreatorPrinter & '\Program', 'AutosaveFilename','REG_SZ','<Username>_<DateTime>') <> 1 Then $iRegError += 1
	...
	If RegWrite('HKCU\Software\PDFCreator\Profiles\' & $g_sPdfCreatorPrinter & '\Program', 'EditWithPDFArchitect','REG_SZ','0') <> 1 Then $iRegError += 1
	...
	If RegWrite('HKCU\Software\PDFCreator\Profiles\' & $g_sPdfCreatorPrinter & '\Program', 'LastUpdateCheck','REG_SZ','20180319') <> 1 Then $iRegError += 1
	...
	If RegWrite('HKCU\Software\PDFCreator\Profiles\' & $g_sPdfCreatorPrinter & '\Program', 'RunProgramBeforeSavingProgramname','REG_SZ','Scripts\RunProgramBeforeSaving\PopUpMessage.vbs') <> 1 Then $iRegError += 1
	If RegWrite('HKCU\Software\PDFCreator\Profiles\' & $g_sPdfCreatorPrinter & '\Program', 'RunProgramBeforeSavingProgramParameters','REG_SZ','"<outputfile>"') <> 1 Then $iRegError += 1
	...
	If RegWrite('HKCU\Software\PDFCreator\Profiles\' & $g_sPdfCreatorPrinter & '\Program', 'SaveFilename','REG_SZ','<Username>_<DateTime>_<Title>') <> 1 Then $iRegError += 1
